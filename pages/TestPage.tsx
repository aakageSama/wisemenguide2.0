...
const TestPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (Object.keys(answers).length === testQuestions.length) {
      try {
        // Trigger n8n webhook
        await fetch('https://aakagesama.app.n8n.cloud/webhook-test/psychotest', {
          method: 'POST',
          headers: {
        ...
        // Continue to results page even if webhook fails
      }
      
      // On submit, navigate to results page with answers in state
